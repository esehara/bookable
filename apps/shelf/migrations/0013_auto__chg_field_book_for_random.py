...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.for_random'
        db.alter_column(u'shelf_book', 'for_random', self.gf('django.db.models.fields.DecimalField')(unique=True, null=True, max_digits=32, decimal_places=20))

    def backwards(self, orm):

        # Changing field 'Book.for_random'
        db.alter_column(u'shelf_book', 'for_random', self.gf('django.db.models.fields.FloatField')(unique=True, null=True))
