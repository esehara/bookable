...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Keyword.times'
        db.add_column(u'shelf_keyword', 'times',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Keyword.text'
        db.alter_column(u'shelf_keyword', 'text', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Keyword.times'
        db.delete_column(u'shelf_keyword', 'times')


        # User chose to not deal with backwards NULL issues for 'Keyword.text'
        raise RuntimeError("Cannot reverse this migration. 'Keyword.text' and its values cannot be restored.")
