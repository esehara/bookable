...
DATABASES = {
    'default': {
        ...
        'NAME': 'bookable',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'u*z69ya61!py9#2-_f&amp;$z02!l9uyi+b50xf&amp;fncck6y#(ad89k'
...
if not DEBUG:
    ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'bookable.jp']
